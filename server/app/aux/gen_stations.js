...
var stationTypeTemplates = {
  static: {
    type: 'static',
    possible_apps: ['Milky Way at different wavelengths', 'Slideshow: Milky Way', 'Slideshow: Relativity']
  },
  interactive: {
    type: 'interactive',
    possible_apps: ['Black hole pong', 'Habitable zone', 'Stellar evolution', 'Day & night, time zones', 'Moon phases & eclipses', 'Chilean night sky', 'Illustris explorer', 'Signal delay', 'Galaxy zoo', 'Time relativity', 'Sky explorer / Aladin lite']
  },
  kinect: {
    type: 'kinect',
    possible_apps: ['Floor projection "star formation"']
  },
  vr: {
    type: 'vr',
    possible_apps: ['Formation of the moon AR', 'Solar system formation AR', 'VR experience of ESO sites']
  },
  special: {
    type: 'special',
    possible_apps: ['Galaxy collision touch table', 'Science on a half-sphere', 'Science on a sphere', 'Solar system explorer', 'IR/UV/optical camera', 'ALMA Interferometry', 'Relativity bike']
  }
};

var StationGenerator = function () {
  function StationGenerator() {
    _classCallCheck(this, StationGenerator);

    this.stations = [];
  }

  _createClass(StationGenerator, [{
    key: 'addStation',
    value: function addStation(name, type, appNumber) {
      var newStation = {};
...
var generator = new StationGenerator();
...
//# sourceMappingURL=gen_stations.js.map
