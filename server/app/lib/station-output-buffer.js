...
var StationOutputBuffer = function (_Writable) {
  _inherits(StationOutputBuffer, _Writable);

  function StationOutputBuffer(options) {
    _classCallCheck(this, StationOutputBuffer);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StationOutputBuffer).call(this, options));
  ...
  _createClass(StationOutputBuffer, [{
    key: '_write',
  ...
  return StationOutputBuffer;
}(Writable);

exports.default = StationOutputBuffer;


StationOutputBuffer.DEFAULT_MAX_LINES = 80;
//# sourceMappingURL=station-output-buffer.js.map
